  ...
  return (
    <Card className="mb-6">
      ...
      <CardContent className="p-0">
        const photoUrl = data.photos && data.photos[0]?.cdnUrl ? data.photos[0].cdnUrl : "";
        <img src={data.photoURL} className="w-10 h-10 rounded-full border-2 border-slate-800 object-cover" alt="User"
       />
      </CardContent>
